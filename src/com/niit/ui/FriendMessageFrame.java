...
import com.niit.image.friendmsgPanel;
...
//	private StartClient startClient;
	 ...
	 * Create the frame.
	 */
	public FriendMessageFrame(StartClient startClient, String friendAcc) {
//		this.startClient = startClient;
		...
		for (Friends f : friendList) {
			if(f.getAccount().equals(friendAcc)) {
				//得到账号信息
				textField.setText(f.getAccount());
				//得到昵称信息
				textField_2.setText(f.getName());
				//得到年龄信息
				textField_1.setText(f.getAge() + "");
				//得到性别信息
				textField_4.setText(f.getSex());
				//得到城市信息
				textField_3.setText(f.getCity());
			} 
		}
	}
	...
	public void init() {
		//标题栏图片
		setIconImage(Toolkit.getDefaultToolkit().getImage(FriendMessageFrame.class.getResource("/com/niit/ui/loginframe.jpg")));
		//标题
		setTitle("\u597D\u53CB\u8D44\u6599");
		//窗体居中
		...
		//添加背景图片
		contentPane = new friendmsgPanel();
		...
		//个人资料
		JLabel lblNewLabel = new JLabel("\u597D\u53CB\u8D44\u6599");
